...
def create_database():
    ...
    conn = ps.connect("host=127.0.0.1 dbname=postgres user=postgres password=peakyboy")
    ...
    conn = ps.connect("host=127.0.0.1 dbname=sparkifydb user=mahdi password=test1234")
    cur = conn.cursor()
